...
//@Disabled
public class Teleop_Quad_Training_With_Camera_Align extends OpMode {
    ...
    //private double NEW_IR = 5;
    //private double NEW_DR = 0;
    ...
    @Override
    public void init() {
        /* Initialize the hxs2ardware variables.
       ...
       //PIDCoefficients pidSettingsR = new PIDCoefficients(NEW_PR, NEW_IR, NEW_DR);
       //robot.rightArm.setPIDCoefficients(DcMotor.RunMode.RUN_USING_ENCODER, pidSettingsR);
